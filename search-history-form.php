                    ...
                    <div class="form-group">
                        <label>เลขทะเบียนรถ</label>
                            <div class="form-inline">
                                <input type="text" class="form-control form-control-sm" name="car_char" placeholder="โหมดอักษร" required> - 
                                <input type="text" class="form-control form-control-sm" name="car_number" placeholder="ตัวเลขทะเบียน" required> - 
