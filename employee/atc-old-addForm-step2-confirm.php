<?php
$id_order_service = $_POST['id_order_service'];
$id_car = $_POST['id_car'];
...
<div class="row">
    <div class="col-md-12">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td> <?=number_format($ปปปปปปปปปปปปปป)?> </td>
        ...
        <div class="text-center">
            <form action="index.php?menu=atc-old-addForm-step3-DB" method="post">
