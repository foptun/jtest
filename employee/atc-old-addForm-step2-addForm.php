            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tel" class="form-control form-control-sm" value="<?=$tel?>" required>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>เลขทะเบียนรถ</label>
                            <div class="form-inline">
                                <input type="text" class="form-control form-control-sm" name="car_char" value="<?=$car_char?>" placeholder="โหมดอักษร" required> - 
                                <input type="text" class="form-control form-control-sm" name="car_number" value="<?=$car_number?>" placeholder="ตัวเลขทะเบียน" required> - 
